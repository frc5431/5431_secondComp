...
public class driveBase {
	 ...
	 */
	public driveBase(boolean mode){										//Constructor used if brakeMode is specified (should be but probably won't be used){
		frontright = new CANTalon(RobotMap.frontright);				//Instantiates CANTalons based on mapping in RobotMap
		frontleft = new CANTalon(RobotMap.frontleft);
		rearright = new CANTalon(RobotMap.rearright);
		rearleft = new CANTalon(RobotMap.rearleft);									//If in BrakeMode, set CANTalons to brakeMode, otherwise, don't
